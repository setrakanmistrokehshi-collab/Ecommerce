...
const { getCacheClient } = require('../config/redis');   // ← changed
...
router.get(
  ...
  async (req, res) => {
    try {
      const redis = getCacheClient();   // ← changed
...
// Step 3 — Frontend exchanges the one-time code for tokens
